...
<h2 className={`${styles.h2} ${styles.redText}`}> WE ARE CURRENTLY IN THE PROCESS OF MIGRATING TO A NEW CONTRACT.<br></br> ANY GEN2 BOTS HELD WILL BE AIRDROPPED WHEN NEW CONTRACT DEPLOYS. </h2>
