...
<br></br>
      ...
      <p className={styles.explain}>
        Connect Your Wallet Above To Claim Your <a href="https://opensea.io/collection/bots-of-cog-gen2"><b>BOTS OF COG</b> Generation 2 Series Robot</a>.
        <br></br>
        Bridge Your ETH to MATIC Below using the <a href="https://bridge.umbria.network/"><b>UBMBRIA Network Bridge</b></a>.
      </p>
      <iframe src="https://umbria.network/widgetv2/" width="960" height="600" scrolling="no"></iframe>
      <br></br>
      <hr className={`${styles.smallDivider} ${styles.detailPageHr}`} />
