...
const Stake: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      <h1 className={styles.h1}>THE BOTS OF COG REPOSITORY</h1>
      <div className={styles.tokenItem}>
        <h3 className={`${styles.tokenLabel} ${styles.blueText}`}>Total COGz In Repo:</h3>
